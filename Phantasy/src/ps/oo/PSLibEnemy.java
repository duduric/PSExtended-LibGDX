...
public class PSLibEnemy {
		...
		public static HashMap<GenericEnemy, Enemy> initializeOriginalEnemies() {
			...
			addEnemy(enemies, PS1Enemy.DARKFALZ, new Enemy("Enemy_Dark_Force").hp(1510).atk(255).def(150).exp(0).mst(0).run(0).rope(CanRope.NO).special(Special.DOUBLE_ATTACK).prot(CanProt.NO).sound(PS1Sound.THUNDER).anim("battle/enemy_ps1/darkfalz.chr").mental(Mental.LOWER).vertical(44).contact(110).type(Type.NONE));
